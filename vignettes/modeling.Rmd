...
The underlying [Stan](https://mc-stan.org) models are compiled the
first time the models are used. Thereafter, the models will not need
to be re-compiled. The model's Stan code can be found in the `artemis` source code [here](https://github.com/fishsciences/artemis/tree/master/inst/stan_files). 
