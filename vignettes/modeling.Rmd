...
from the data prior to modeling, we recommend removing `NA` value
prior to modeling. This allows inspection and potentially correction
of the rows with `NA` values. For example, 
