...
test_that("P-detect: basic tests", {
    ...
    expect_error(est_p_detect(variable_levels = c(intecept = 1, Distance = 500, Volume = 50),
                 betas = c(intercept = -10.6, Distance = -0.005),
                 Cq_sd = 1, n_rep = 6, std_curve_alpha = 21.2, std_curve_beta = -1.5))

    res = est_p_detect(variable_levels = c(intecept = 1, Distance = 300, Volume = 0),
    ...
    expect_error(est_p_detect(variable_levels = c(intecept = 1, Distance = 300,
                                             Volume = c(0, 20)),
                              betas = c(intercept = -10.6, Distance = -0.5, Volume = -0.1),
                              Cq_sd = 1, n_rep = 3, std_curve_alpha = 21.2, std_curve_beta = -1.5))
